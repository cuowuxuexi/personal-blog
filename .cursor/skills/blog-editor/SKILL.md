...
2. Hermes 日记已停用；只有作者明确要求恢复时才读：`docs/agents/hermes-diary.md` 与 `docs/AI与生活/Hermes日记/README.md`
3. 涉及 `docs/投资/**` 内容认识时再读：`CONTEXT.md` 与 `docs/agents/research-publishing.md`
