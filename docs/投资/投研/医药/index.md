...
<section class="research-section" aria-labelledby="medical-paths">
  <header class="research-section-head">
    <div><p>ENTRY / 研究入口</p><h2 id="medical-paths">先判断研究对象卖什么</h2></div>
  </header>
  <div class="knowledge-route-grid">
    <article><span>CXO</span><h3>替药企做研究、开发或生产</h3><p>先读研发与制造双线，再用 R/D/M 和药物类型定位公司。</p><a href="/投资/投研/医药/研究地图/CXO与CRDMO/">进入 CXO 路径 →</a></article>
    <article><span>DRUG SELLER</span><h3>拥有管线并销售药品</h3><p>先分药物身份、管线阶段、专利与替代，再看医保谈判和集采。</p><a href="/投资/投研/医药/研究地图/原研仿制与支付端/">进入卖药路径 →</a></article>
  </div>
</section>
...
<section class="subject-directory" aria-labelledby="medical-maps">
  ...
  <a class="subject-row" href="/投资/投研/医药/研究地图/">
    <div><span class="subject-row__ticker">GRAPH</span><strong>医药知识图谱总览</strong></div>
    <p>药物身份、研发验证、CMC 与制造、外包角色、支付传导和公司映射的总体拓扑。</p>
